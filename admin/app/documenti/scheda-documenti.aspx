                  	...
                  	<% if (strAzione!="new"){ %>
            			    ...
            			    <div class="dropdown-pane" id="dropdowntipodocumenti" data-dropdown data-hover="true" data-hover-pane="true">
            					...
            					<% for (int i = 0; i < dtDocumentiTipo.Rows.Count; i++){ %>
            						<li><a href="/admin/app/documenti/scheda-documenti.aspx?azione=new&DocumentiTipo_Ky=<%=dtDocumentiTipo.Rows[i]["DocumentiTipo_Ky"].ToString()%>" class="tiny"><i class="fa-duotone fa-square-plus fa-fw"></i><%=dtDocumentiTipo.Rows[i]["DocumentiTipo_Descrizione"].ToString()%></a></li>
            					<% } %>
            				    </ul>
            			    </div>

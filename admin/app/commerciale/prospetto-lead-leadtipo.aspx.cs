...
public partial class _Default : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (Smartdesk.Login.Verify){
            ...
            strH1="Commerciale > Prospetto lead per tipo";
			      strAnno=Request["anno"];
			      strMese=Request["mese"];
            dtProspettoLead = new DataTable("Lead_Prospetto_LeadTipo_Vw");
            ...
            strWHERENet="";
	          strFROMNet = "LeadTipo";
            strORDERNet = "LeadTipo_Ordine";
            dtLeadTipo = new DataTable("LeadTipo");
            dtLeadTipo = Smartdesk.Sql.getTablePage(strFROMNet, null, "LeadTipo_Ky", strWHERENet, strORDERNet, 1,1000,Smartdesk.Config.Sql.ConnectionReadOnly, out this.intNumRecords);         

            strWHERENet="Anno=" + strAnno + " AND mese=" + strMese;
	          strFROMNet = "Lead_Prospetto_LeadTipo_Vw";
            strORDERNet = "Anno, Mese, LeadTipo_Titolo";

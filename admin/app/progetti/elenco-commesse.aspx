    ...
    <div class="grid-x grid-padding-x align-middle">
        ...
        <div class="large-8 medium-8 small-12 cell float-right align-middle">
            ...
            <div class="dropdown-pane" id="print-dropdown" data-dropdown data-auto-focus="true">
        			...
        			<a href="/admin/app/progetti/report/rpt-commesse-elenco.aspx?sorgente=elenco-commesse" target="_blank"><i class="fa-duotone fa-print fa-lg fa-fw"></i>Stampa elenco</a>
            </div>      
      			<a href="/admin/app/progetti/actions/aggiorna-commesse.aspx?sorgente=elenco-commesse" class="button clear"><i class="fa-duotone fa-sync fa-lg fa-fw"></i>Aggiorna stato progetti</a>
    ...
    <table class="grid hover scroll" border="0" width="100%">
    	<thead>
	      <tr>
	        ...
	        <th width="150" class="text-center">Progetto</th>
		    ...
		    <%
		        ...
		        <tr class="riga<%=i%2%>">
		          ...
		          <td class="show-for-medium-up text-center nowrap">
								<div class="width150"><i class="<%=dtGridData.Rows[i]["CommesseTipo_Icona"].ToString()%> fa-fw"></i><%=dtGridData.Rows[i]["CommesseTipo_Titolo"].ToString()%></div>
								<div class="width150"><%=dtGridData.Rows[i]["Commesse_Riferimenti"].ToString()%></div>
							</td>
		          <td>
                ...
                <small>
								<% 
                  string s=dtGridData.Rows[i]["Commesse_Tags"].ToString();
                  string[] subs = s.Split(',');
                  foreach (var sub in subs)
                  {
                      Response.Write("<span class=\"secondary\">" + sub + "&nbsp;</span>");
                  }                  
                %>
                </small>
							</td>
		          <td>
							...
							<td class="large-text-right small-text-left">
								...
								impiegate: <i class="fa-duotone fa-clock fa-fw"></i> <%=dtGridData.Rows[i]["Commesse_OreImpiegate"].ToString()%><br>
								<% if (dtGridData.Rows[i]["CommesseTipo_Ky"].ToString()=="2"){ %>
                residue: <i class="fa-duotone fa-clock fa-fw"></i> <%=Smartdesk.Functions.GetOreResidue(dtGridData.Rows[i]["Commesse_OreResidue"].ToString())%>
                <% } %>
							</td>
			      	<% if (boolAdmin && dtLogin.Rows[0]["UtentiGruppi_Amministrazione"].Equals(true)){ %>

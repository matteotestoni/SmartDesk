<%@ Page codepage="65001" Language="C#" AutoEventWireup="true" CodeFile="/admin/app/officina/report/rpt-scheda-officina-preparazione.aspx.cs" Inherits="_Default" Debug="true"%>
<!DOCTYPE html>
<html>
<head>
    ...
    <td width="60%" align="right">
      <div style="border:0;padding:20px;width:7cm;text-align:left">
        <div class="tipodocumento">Scheda Officina</div>
          <div>Numero: <strong><%=dtOfficina.Rows[0]["Officina_Ky"].ToString()%></strong></div>
        </div>
    </td>
  </tr>
  </table>

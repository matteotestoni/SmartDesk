...
<body class="reporta4verticale" style="margin-left:5px;">
  ...
  <hr>
    ...
    <div class="row">
      ...
      <div class="large-10 medium-10 small-12 columns"><%=Smartdesk.Data.Field(dtAste, "Aste_Indirizzo")%> <%=Smartdesk.Data.Field(dtAste, "Comuni_Comune")%>, <%=Smartdesk.Data.Field(dtAste, "Province_Provincia")%>, <%=Smartdesk.Data.Field(dtAste, "Regioni_Regione")%>, <%=Smartdesk.Data.Field(dtAste, "Nazioni_Nazione")%></div>
		</div>
    <div class="row">
      			...
      			<td colspan="6">
							<table class="grid hover scroll" border="0" width="100%">
							    ...
							    <tr>
										...
										<th width="40" class="large-text-center small-text-left">Data ora sec. millisec.</th>
					        ...
					        <tr class="riga<%=i%>">
					    			...
					    			<td class="large-text-center small-text-left"><i class="fa-duotone fa-calendar-days fa-fw"></i><%=dtAnnunciOfferte.Rows[0]["AnnunciOfferte_Data"].ToString()%>.<%=dtAnnunciOfferte.Rows[0]["AnnunciOfferte_Millisecondi"].ToString()%></td>

      ...
      if (Smartdesk.Login.Verify){
            ...
            int intNum =0;
		        ...
		        if ((strInput!=null) && (strInput!="")){
		          ...
		          strWHERE = "(Annunci_Titolo like '%" + strInput + "%' Or Annunci_Descrizione like '%" + strInput + "%')";
		        }else{
		          strWHERE = "Not (Annunci_Titolo Is Null)";  
		        }
		        strWHERE = getWhere();
		        strSQL = "SELECT TOP 10 Annunci_Ky,Annunci_Titolo FROM Annunci WHERE " + strWHERE + " ORDER BY Annunci_Titolo";
		        ...
		        Response.Clear();
			        ...
			        while (objReader.Read()){
							...
							objX.WriteLine("{");
			                objX.WriteLine("\"id\" : \"" + objReader["Annunci_Ky"].ToString() + "\",");
			                objX.WriteLine("\"label\" : \"" + objReader["Annunci_Titolo"].ToString() + "\",");
			                objX.WriteLine("\"value\" : \"" + objReader["Annunci_Ky"].ToString() + "\"");
			                objX.WriteLine("}");
			                intNum++;
				     }
					objX.WriteLine("]");

...
<head>
  ...
  <link rel="manifest" href="/img/favicon/manifest.json">
	<link type="text/css" rel="stylesheet" href="/lib/foundation6.7.4/css/app.css">
  ...
  <hr>
	...
	<fieldset class="fieldset">
  	...
  	<div class="row">
    	...
    	<div class="large-4 medium-4 small-12 columns"><%=Smartdesk.Data.Field(dtAnnunci, "Annunci_Ky")%></div>
    	<div class="large-2 medium-2 small-12 columns"><label>Titolo</label></div>
    	<div class="large-4 medium-4 small-12 columns"><%=Smartdesk.Data.Field(dtAnnunci, "Annunci_Titolo")%></div>
    </div>
  	<div class="row">
    	<div class="large-2 medium-2 small-12 columns"><label>Stato</label></div>
    	<div class="large-4 medium-4 small-12 columns"><%=Smartdesk.Data.Field(dtAnnunci, "AnnunciStato_Titolo")%></div>
    	<div class="large-2 medium-2 small-12 columns"><label>Categoria</label></div>
    	<div class="large-4 medium-4 small-12 columns"><%=Smartdesk.Data.Field(dtAnnunci, "AnnunciCategorie_Titolo")%></div>
    </div>
  	<div class="row">
    	<div class="large-2 medium-2 small-12 columns"><label>Valore</label></div>
    	<div class="large-4 medium-4 small-12 columns"><%=Smartdesk.Data.Field(dtAnnunci, "Annunci_Valore")%></div>
    </div>
  	<div class="row">
    	<div class="large-2 medium-2 small-12 columns"><label>Cauzione</label></div>
    	<div class="large-4 medium-4 small-12 columns"><%=Smartdesk.Data.Field(dtAnnunci, "Annunci_Cauzione")%></div>
    	<div class="large-2 medium-2 small-12 columns"><label>Rilancio</label></div>
    	<div class="large-4 medium-4 small-12 columns"><%=Smartdesk.Data.Field(dtAnnunci, "Annunci_Rilancio")%></div>
    </div>
  	<div class="row">
    	<div class="large-2 medium-2 small-12 columns"><label>Visite</label></div>
    	<div class="large-4 medium-4 small-12 columns"><%=Smartdesk.Data.Field(dtAnnunci, "Annunci_Visite")%></div>
    </div>
  	<div class="row">
    	<div class="large-2 medium-2 small-12 columns"><label>Note</label></div>
    	<div class="large-10 medium-10 small-12 columns"><%=Smartdesk.Data.Field(dtAnnunci, "Annunci_Note")%></div>
    </div>
  	<div class="row">
    	<div class="large-2 medium-2 small-12 columns"><label>Note pubblicit&agrave;</label></div>
    	<div class="large-10 medium-10 small-12 columns"><%=Smartdesk.Data.Field(dtAnnunci, "Annunci_NotePubblicita")%></div>
    </div>
	</fieldset>

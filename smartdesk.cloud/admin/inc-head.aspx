  ...
  <meta name="version" content="<%Response.Write(System.IO.File.ReadLines(Server.MapPath("/version.txt")).First());%>">
  ...
  <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/zf/dt-1.12.1/r-2.3.0/datatables.min.css"/>
  <link type="text/css" rel="stylesheet" href="https://code.jquery.com/ui/1.13.2/themes/base/jquery-ui.min.css" media="screen, print">	
  <link type="text/css" rel="stylesheet" href="/admin/rswcrm-print.css" media="print" />
  ...
  <script type="text/javascript" src="https://cdn.smartdesk.cloud/lib/foundation-datepicker/js/foundation-datepicker.min.js"></script>
  <script type="text/javascript" src="https://cdn.datatables.net/v/zf/dt-1.12.1/r-2.3.0/datatables.min.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.1.0-rc.0/js/select2.min.js" integrity="sha512-4MvcHwcbqXKUHB6Lx3Zb5CEAVoE9u84qN+ZSMM6s7z8IeJriExrV3ND5zRze9mxNlABJ6k864P/Vl8m0Sd3DtQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
  <script type="text/javascript" src="/admin/rswcrm.js?id=<%Response.Write(System.IO.File.ReadLines(Server.MapPath("/version.txt")).First());%>"></script>

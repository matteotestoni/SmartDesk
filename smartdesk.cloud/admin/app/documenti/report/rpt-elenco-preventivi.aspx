<%@ Page codepage="65001" Language="C#" AutoEventWireup="true" CodeFile="rpt-elenco-preventivi.aspx.cs" Inherits="_Default" Debug="true"%>
<!DOCTYPE html>
<html>
<head>
  ...
  <tr>
    ...
    <td width="60%" align="right">
      <div style="border:0;padding:10px;width:8cm;text-align:left">
        <div class="tipodocumento">Elenco preventivi</div>
				<br style="clear:both">                                                                 
        ...
        intAnno=Convert.ToDateTime(dtDocumenti.Rows[i]["Documenti_Data"]).Year;
	      ...
	      %>
	        ...
	        <tr class="riga<%=i%2%>">
	          ...
	          <td>
	            <a href="/admin/app/documenti/scheda-documenti.aspx?CoreModules_Ky=13&CoreEntities_Ky=44&CoreForms_Ky=1212&Documenti_Ky=<%=dtDocumenti.Rows[i]["Documenti_Ky"].ToString()%>&azione=modifica" class="funzione"><%=dtDocumenti.Rows[i]["Documenti_Ky"].ToString()%></a> 
	          </td>
	          <td class="large-text-center small-text-left"><strong><%=dtDocumenti.Rows[i]["DocumentiTipo_Descrizione"].ToString()%></strong></td>
	          <td class="large-text-center small-text-left"><a href="/admin/app/documenti/scheda-documenti.aspx?CoreModules_Ky=13&CoreEntities_Ky=44&CoreForms_Ky=1212&Documenti_Ky=<%=dtDocumenti.Rows[i]["Documenti_Ky"].ToString()%>&azione=modifica" class="funzione"><strong><%=dtDocumenti.Rows[i]["Documenti_Numero"].ToString()%></strong></a></td>
	          <td class="large-text-center small-text-left"><a href="/admin/app/documenti/scheda-documenti.aspx?CoreModules_Ky=13&CoreEntities_Ky=44&CoreForms_Ky=1212&Documenti_Ky=<%=dtDocumenti.Rows[i]["Documenti_Ky"].ToString()%>&azione=modifica" class="funzione"><i class="fa-duotone fa-calendar-days fa-fw"></i><strong><%=dtDocumenti.Rows[i]["Documenti_Data_IT"].ToString()%></strong></a></td>
	          <td>
	          	<div class="width200">
	            <a href="/admin/goto-form.aspx?CoreEntities_Ky=162&Anagrafiche_Ky=<%=dtDocumenti.Rows[i]["Anagrafiche_Ky"].ToString()%>&Documenti_Ky=<%=dtDocumenti.Rows[i]["Documenti_Ky"].ToString()%>&azione=modifica" class="funzione" title="Telefono: <%=dtDocumenti.Rows[i]["Anagrafiche_Telefono"].ToString()%>"><i class="fa-duotone fa-users fa-fw"></i><%=dtDocumenti.Rows[i]["Anagrafiche_RagioneSociale"].ToString()%></a>
							</div> 
	          </td>
	          ...
	          <td class="text-left">
							...
							<% if (dtDocumenti.Rows[i]["Commesse_Ky"].ToString().Length>0){ %>
								| Progetto:<a href="/admin/goto-form.aspx?CoreEntities_Ky=107&Commesse_Ky=<%=dtDocumenti.Rows[i]["Commesse_Ky"].ToString()%>&sorgente=elenco-documenti" class="funzione" title="<%=dtDocumenti.Rows[i]["Commesse_Titolo"].ToString()%>"><i class="fa-duotone fa-circle-info fa-fw"></i><%=dtDocumenti.Rows[i]["Commesse_Riferimenti"].ToString()%></a>
							<% } %>
							</div>
						</td>
	        </tr>

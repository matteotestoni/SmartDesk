...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlConnection objConnection = new SqlConnection(Smartdesk.Config.Sql.ConnectionReadOnly);
		    objConnection.Open();
        strTable="Nazioni";
        strFields= "Nazioni_Ky,Nazioni_Nazione";
        strCompare= "Nazioni_Nazione";
        strKey="Nazioni_Ky";
        strLabel= "Nazioni_Nazione";
        ...
        if ((strInput!=null) && (strInput!="")){
            strInput=strInput.Replace("'","''");
            strWHERE = "(Nazioni_Nazione like '%" + strInput + "%')";
          }else{
            strWHERE = "Not (Nazioni_Nazione Is Null)";  
          }
        strSQL = "SELECT TOP 10 " + strFields + " FROM " + strTable + " WHERE " + strWHERE + " ORDER BY " + strCompare;

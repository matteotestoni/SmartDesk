      ...
      if (Smartdesk.Login.Verify){
            ...
            int intNum =0;
		        ...
		        if ((strInput!=null) && (strInput!="")){
		          ...
		          strWHERE = "(Aste_Titolo like '%" + strInput + "%' Or Aste_Descrizione like '%" + strInput + "%')";
		        }else{
		          strWHERE = "Not (Aste_Titolo Is Null)";  
		        }
		        strWHERE = getWhere();
		        strSQL = "SELECT TOP 10 Aste_Ky,Aste_Titolo FROM Aste WHERE " + strWHERE + " ORDER BY Aste_Titolo";
		        ...
		        Response.Clear();
			        ...
			        while (objReader.Read()){
							...
							objX.WriteLine("{");
			                objX.WriteLine("\"id\" : \"" + objReader["Aste_Ky"].ToString() + "\",");
			                objX.WriteLine("\"label\" : \"" + objReader["Aste_Titolo"].ToString() + "\",");
			                objX.WriteLine("\"value\" : \"" + objReader["Aste_Ky"].ToString() + "\"");
			                objX.WriteLine("}");
			                intNum++;
				     }
					objX.WriteLine("]");

...
public partial class _Default : System.Web.UI.Page 
{
	...
	if (Smartdesk.Login.Verify){
		...
		dtAsteEsperimenti = Smartdesk.Data.Read("AsteEsperimenti_Vw", "AsteEsperimenti_Ky",strAsteEsperimenti_Ky);
		strAste_Ky=dtAsteEsperimenti.Rows[0]["Aste_Ky"].ToString();
		dtAste = Smartdesk.Data.Read("Aste_Vw", "Aste_Ky", strAste_Ky );
		dtAsteCauzioni = Smartdesk.Data.Read("AsteCauzioni_Vw", "AsteEsperimenti_Ky",strAsteEsperimenti_Ky);
		dtAnnunci = Smartdesk.Data.Read("Annunci_Vw", "Aste_Ky",strAste_Ky);
		dtAnnunciOfferte = Smartdesk.Data.Read("AnnunciOfferte_Vw", "Aste_Ky",strAste_Ky);

...
public partial class _Default : System.Web.UI.Page 
{
    ...
    public DataTable dtProspettoSpeseAnnoPrecendente;
    public DataTable dtProspettoSpeseCentridiCR;
    public DataTable dtProspettoSpeseCentridiCRAnnoPrecendente;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (Smartdesk.Login.Verify){
          ...
          strWHERENet="Anno=" + intAnnoPrecedente;
		      strFROMNet = "Spese_Prospetto_Vw";
          strORDERNet = "Anno, Mese";
          dtProspettoSpeseAnnoPrecendente = new DataTable("ProspettoSpeseAnnoPrecendente");
          dtProspettoSpeseAnnoPrecendente = Smartdesk.Sql.getTablePage(strFROMNet, null, "chiave", strWHERENet, strORDERNet, 1,1000,Smartdesk.Config.Sql.ConnectionReadOnly, out this.intNumRecords);         
          ...
          dtProspettoSpeseCentridiCR = Smartdesk.Sql.getTablePage(strFROMNet, null, "chiave", strWHERENet, strORDERNet, 1,1000,Smartdesk.Config.Sql.ConnectionReadOnly, out this.intNumRecords);         
    			arrayspeseannoprecedente = new string[1000,1000];            

    			strWHERENet="Anno=" + intAnnoPrecedente;
          strFROMNet = "Spese_Prospetto_CentridiCR_Vw";
          strORDERNet = "CentridiCR_Titolo, Mese";
          dtProspettoSpeseCentridiCRAnnoPrecendente = new DataTable("ProspettoSpeseCentridiCRAnnoPrecedente");
          dtProspettoSpeseCentridiCRAnnoPrecendente = Smartdesk.Sql.getTablePage(strFROMNet, null, "chiave", strWHERENet, strORDERNet, 1,1000,Smartdesk.Config.Sql.ConnectionReadOnly, out this.intNumRecords);         
          ...
          for (int i = 0; i < dtProspettoSpeseCentridiCRAnnoPrecendente.Rows.Count; i++){
            arrayspeseannoprecedente[(int)(dtProspettoSpeseCentridiCRAnnoPrecendente.Rows[i]["CentridiCR_Ky"]),0]="<a href=\"/admin/app/amministrazione/elenco-spese.aspx?CoreModules_Ky=2&CoreEntities_Ky=1&CoreGrids_Ky=1&CentridiCR_Ky=" + (dtProspettoSpeseCentridiCRAnnoPrecendente.Rows[i]["CentridiCR_Ky"]).ToString() + "&anno=" + intAnnoPrecedente + "\">" + (dtProspettoSpeseCentridiCRAnnoPrecendente.Rows[i]["CentridiCR_Titolo"]).ToString() + "</a>";
            arrayspeseannoprecedente[(int)(dtProspettoSpeseCentridiCRAnnoPrecendente.Rows[i]["CentridiCR_Ky"]),(int)(dtProspettoSpeseCentridiCRAnnoPrecendente.Rows[i]["Mese"])]=(dtProspettoSpeseCentridiCRAnnoPrecendente.Rows[i]["Spese_Totale"]).ToString();
          }

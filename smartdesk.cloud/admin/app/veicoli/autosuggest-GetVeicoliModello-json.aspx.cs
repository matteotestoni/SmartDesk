...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		objConnection.Open();
        strTable="VeicoliModello_Vw";
        strFields= "VeicoliModello_Ky,VeicoliModello_Titolo";
        strCompare= "VeicoliModello_Titolo";
        strKey="VeicoliModello_Ky";
        strLabel= "VeicoliModello_Titolo";
        ...
        if ((strInput!=null) && (strInput!="")){
            strInput=strInput.Replace("'","''");
            strWHERE = "(VeicoliModello_Titolo like '%" + strInput + "%')";
          }else{
            strWHERE = "Not (VeicoliModello_Titolo Is Null)";  
          }
        strSQL = "SELECT TOP 10 " + strFields + " FROM " + strTable + " WHERE " + strWHERE + " ORDER BY " + strCompare;

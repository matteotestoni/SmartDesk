    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (Smartdesk.Login.Verify){
          ...
          new Smartdesk.Sql().SQLScriptExecuteNonQuery(strSQL);
            ...
            intValore=Convert.ToInt32(dtVeicoli.Rows[i]["Veicoli_Valore"]) ;
            intSconto=0;
            intValoreInOfferta=intValore-intSconto;

            if (intValoreInOfferta<intValore){
              strSQL="INSERT INTO VeicoliOfferteAuto (VeicoliOfferte_Ky, Veicoli_Targa, Veicoli_Sconto, Veicoli_ValoreInOfferta, Veicoli_ValoreTagliato, Veicoli_Valore, VeicoliOfferteAuto_UserInsert, VeicoliOfferteAuto_DateInsert)";
              strSQL+=" VALUES (" + strVeicoliOfferte_Ky + ",'" + dtVeicoli.Rows[i]["Veicoli_Targa"].ToString() + "', " + intSconto + "," + intValoreInOfferta + "," + intValore + "," + intValore + ",0,GETDATE());";
            }else{
              strSQL="INSERT INTO VeicoliOfferteAuto (VeicoliOfferte_Ky, Veicoli_Targa, Veicoli_Sconto, Veicoli_ValoreInOfferta, Veicoli_ValoreTagliato, Veicoli_Valore, VeicoliOfferteAuto_UserInsert, VeicoliOfferteAuto_DateInsert)";
              strSQL+=" VALUES (" + strVeicoliOfferte_Ky + ",'" + dtVeicoli.Rows[i]["Veicoli_Targa"].ToString() + "', " + intSconto + "," + intValore + ",0," + intValore + ",0,GETDATE());";
            }

      ...
      if (Smartdesk.Login.Verify){
            ...
            int intNum =0;
		        ...
		        if ((strInput!=null) && (strInput!="")){
		          ...
		          strWHERE = "(Veicoli_Titolo like '%" + strInput + "%' Or Veicoli_Descrizione like '%" + strInput + "%')";
		        }else{
		          strWHERE = "Not (Veicoli_Titolo Is Null)";  
		        }
		        strWHERE = getWhere();
		        strSQL = "SELECT TOP 10 Veicoli_Ky,Veicoli_Titolo FROM Veicoli WHERE " + strWHERE + " ORDER BY Veicoli_Titolo";
		        ...
		        Response.Clear();
			        ...
			        while (objReader.Read()){
							...
							objX.WriteLine("{");
			                objX.WriteLine("\"id\" : \"" + objReader["Veicoli_Ky"].ToString() + "\",");
			                objX.WriteLine("\"label\" : \"" + objReader["Veicoli_Titolo"].ToString() + "\",");
			                objX.WriteLine("\"value\" : \"" + objReader["Veicoli_Ky"].ToString() + "\"");
			                objX.WriteLine("}");
			                intNum++;
				     }
					objX.WriteLine("]");

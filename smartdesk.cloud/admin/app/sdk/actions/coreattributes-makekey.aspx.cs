  ...
  public partial class _Default : System.Web.UI.Page 
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (Smartdesk.Login.Verify){
          ...
          strSQL= "UPDATE CoreAttributes set CoreAttributes_Key=1,CoreAttributes_Search=1,CoreAttributes_Order=1, CoreAttributesType_Ky=5, CoreAttributesFormat_Ky=8 WHERE CoreAttributes_Ky = " + strCoreAttributes_Ky;

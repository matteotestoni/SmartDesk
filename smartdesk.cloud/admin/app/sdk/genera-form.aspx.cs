    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (Smartdesk.Login.Verify){
            ...
            for (int iCoreModules = 0; iCoreModules < dtCoreModules.Rows.Count; iCoreModules++){
	            strWHERENet="CoreEntities_Ky=" + strCoreEntities_Ky + " AND CoreModules_Ky=" + dtCoreModules.Rows[iCoreModules]["CoreModules_Ky"].ToString();
            	...
            	for (int iCoreEntities = 0; iCoreEntities < dtCoreEntities.Rows.Count; iCoreEntities++){
		            ...
		            dtCoreForms = Smartdesk.Sql.getTablePage(strFROMNet, null, "CoreForms_Ky", strWHERENet, strORDERNet, 1, 1,Smartdesk.Config.Sql.ConnectionReadOnly, out this.intNumRecords);
								if (dtCoreForms.Rows.Count<1){
									strSQL="INSERT INTO CoreForms (CoreEntities_Ky,CoreForms_SQLFrom, CoreForms_Custom,CoreForms_Default,CoreForms_Title,CoreForms_Order)";
									strSQL+="VALUES (";
									strSQL+=dtCoreEntities.Rows[iCoreEntities]["CoreEntities_Ky"].ToString() + ",";
									strSQL+="'" + dtCoreEntities.Rows[iCoreEntities]["CoreEntities_Code"].ToString() + "',";
									strSQL+="0,";
									strSQL+="1,";
									strSQL+="'" + dtCoreEntities.Rows[iCoreEntities]["CoreEntities_Title"].ToString() + "',";
									strSQL+="1";
									strSQL+=")";
																...
																for (int iCoreFormsFieldset = 0; iCoreFormsFieldset < dtCoreFormsFieldset.Rows.Count; iCoreFormsFieldset++){
																	...
																	if (dtCoreAttributes.Rows.Count>0){
																			for (int iCoreAttributes = 0; iCoreAttributes < dtCoreAttributes.Rows.Count; iCoreAttributes++){
																				RenderField(iCoreAttributes,iCoreEntities );
																			}
																	}

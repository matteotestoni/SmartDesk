<%@ Page codepage="65001" Language="C#" AutoEventWireup="true" CodeFile="/admin/app/sdk/scheda-coregridscolumns.aspx.cs" Inherits="_Default" Debug="true" validateRequest="false"%>
<!DOCTYPE html>
<html class="no-js" lang="it">
<head>
	<title>SDK > <%=strH1%></title>
	<!--#include file="/admin/inc-head.aspx"-->
	<script type="text/javascript" src="https://cdn.smartdesk.cloud/lib/jquery-querybuilder/interact.min.js"></script>
	<script type="text/javascript" src="https://cdn.smartdesk.cloud/lib/jquery-querybuilder/jQuery.extendext.min.js"></script>
	<script type="text/javascript" src="https://cdn.smartdesk.cloud/lib/jquery-querybuilder/doT.min.js"></script>
	<link rel="stylesheet" href="https://cdn.smartdesk.cloud/lib/jquery-querybuilder/css/query-builder.default.min.css">
	<script type="text/javascript" src="https://cdn.smartdesk.cloud/lib/jquery-querybuilder/js/query-builder.standalone.min.js"></script>
	<script type="text/javascript" src="https://cdn.smartdesk.cloud/lib/jquery-querybuilder/i18n/query-builder.it.js"></script>
	<style>
...
<!--#include file=/admin/inc-mainbar.aspx --> 
  <form id="form-coreattributes" action="/admin/app/sdk/crud/salva-coregridscolumns.aspx" method="post" data-abide novalidate>
		...
		<div class="grid-x grid-padding-x">
			...
			<div class="large-8 medium-6 small-12 cell float-right">
				<div class="stacked-for-small button-group small hide-for-print align-right">
					...
					<a href="/admin/app/sdk/scheda-coregrids.aspx?CoreGrids_Ky=<%=GetFieldValue(dtCoreGrids, "CoreGrids_Ky")%>&CoreModules_Ky=<%=GetFieldValue(dtCoreGrids, "CoreModules_Ky")%>&CoreEntities_Ky=<%=GetFieldValue(dtCoreGrids, "CoreEntities_Ky")%>" class="button secondary"><i class="fa-duotone fa-backward fa-fw"></i>Torna alla griglia</a>
					<a href="/admin/app/sdk/scheda-coreentities.aspx?CoreGrids_Ky=<%=GetFieldValue(dtCoreGrids, "CoreGrids_Ky")%>&CoreModules_Ky=<%=GetFieldValue(dtCoreGrids, "CoreModules_Ky")%>&CoreEntities_Ky=<%=GetFieldValue(dtCoreGrids, "CoreEntities_Ky")%>" class="button secondary"><i class="fa-duotone fa-backward fa-fw"></i>Torna all'entit&agrave;</a>
  ...
  <div class="large-10 medium-10 small-12 cell contenuto">
	...
	<div class="grid-x grid-padding-x">
	  <div class="large-12 medium-12 small-12 cell">
	      ...
	      <input type="hidden" name="CoreGridsColumns_Ky" id="CoreGridsColumns_Ky" value="<%=GetFieldValue(dtCoreGridsColumns, "CoreGridsColumns_Ky")%>">
	      ...
	      <!--#include file=/admin/forms_messaggi.inc -->
				<!--#include file=/admin/app/sdk/forms/coregridscolumns_form.htm -->

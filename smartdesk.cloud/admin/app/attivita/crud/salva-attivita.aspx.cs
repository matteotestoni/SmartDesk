           ...
           //Response.Write(strSorgente);
            ...
            switch (strSorgente)
            {
                ...
                case "scheda-documenti":
                    Response.Redirect("/admin/app/documenti/scheda-documenti.aspx?CoreModules_Ky=13&CoreEntities_Ky=44&salvato=salvato&Documenti_Ky=" + strDocumenti_Ky + "&Utenti_Ky=" + strUtenti_Ky + "#attivita");
                    break;
                case "home":

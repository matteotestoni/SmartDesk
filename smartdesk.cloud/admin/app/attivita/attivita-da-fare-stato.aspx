    ...
    <%	
        ...
        for (iStati = 0; iStati < dtAttivitaStati.Rows.Count; iStati++){
            strHtml+="<div class=\"auto cell\">";
              strHtml+="<h2 class=\"text-center\" style=\"color:#FFA726\">" + dtAttivitaStati.Rows[iStati]["AttivitaStati_Titolo"].ToString() + "<i class=\"fa-duotone fa-arrow-right fa-fw\"></i></h2>";

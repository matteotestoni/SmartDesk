<%@ Page codepage="65001" Language="C#" AutoEventWireup="true" CodeFile="/admin/app/commerciale/prospetto-lead-campagna.aspx.cs" Inherits="_Default" Debug="true"%>
<!DOCTYPE html>
  ...
  <div class="large-12 medium-12 small-12 cell">
    ...
    <div class="divgridfilter">
    	<% for (int i = intYear-1; i <= intYear; i++){ %>
    		...
    		<% for (int j = 1; j <= 12; j++){ %>		
    			<a href="/admin/app/commerciale/prospetto-lead-campagna.aspx?anno=<%=i%>&mese=<%=j%>" class="tiny button secondary"><i class="fa-duotone fa-calendar-days fa-fw"></i><%=Smartdesk.Functions.GetMese(j.ToString())%>/<%=i%></a>
    		<% } %>
    		</div>
    	<% } %>
    </div>
		<div class="divgrid">
  		...
  		<thead>
          <tr>
  	        <th class="text-left">Campagna</th>

      ...
      if (Smartdesk.Login.Verify){
            ...
            int intNum =0;
		        ...
		        if ((strInput!=null) && (strInput!="")){
		          ...
		          strWHERE = "(Commesse_Titolo like '%" + strInput + "%' Or Commesse_Descrizione like '%" + strInput + "%')";
		        }else{
		          strWHERE = "Not (Commesse_Titolo Is Null)";  
		        }
		        strWHERE = getWhere();
		        strSQL = "SELECT TOP 10 Commesse_Ky,Commesse_Titolo FROM Commesse WHERE " + strWHERE + " ORDER BY Commesse_Titolo";
		        ...
		        Response.Clear();
			        ...
			        while (objReader.Read()){
							...
							objX.WriteLine("{");
			                objX.WriteLine("\"id\" : \"" + objReader["Commesse_Ky"].ToString() + "\",");
			                objX.WriteLine("\"label\" : \"" + objReader["Commesse_Titolo"].ToString() + "\",");
			                objX.WriteLine("\"value\" : \"" + objReader["Commesse_Ky"].ToString() + "\"");
			                objX.WriteLine("}");
			                intNum++;
				     }
					objX.WriteLine("]");

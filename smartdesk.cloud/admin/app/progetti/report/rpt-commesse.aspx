...
<body style="margin:0;padding:0;background : #ffffff;color : #000000;border:0;font-size:13px;">
  ...
  <table border="1" cellpadding="2" cellspacing="0" class="totali">
    <tr>
      <td class="riga" align="right"><strong>Totale ore impiegate</strong></td>
      <td class="large-text-right small-text-left" align="right"><strong><%=decTotOre.ToString("N2", ci)%></strong></td>
    </tr>
  </table>
  <div class="footer">

...
public partial class _Default : System.Web.UI.Page 
{
    ...
    public string strH1 = "Statistiche fatturato";
          ...
          dtLogin = Smartdesk.Data.Read("Utenti_Vw","Utenti_Ky", Smartdesk.Session.CurrentUser.ToString());          if (dtLogin.Rows.Count>0){
            ...
            if ((strPage == null) || (strPage == "")){
              ...
              intPage = Convert.ToInt32(strPage);
        		...
        		strH1="Stastistiche sul fatturato delle anagrafiche";
            strWHERENet="Anagrafiche_Disdetto<>1 And Anno=2015";
            strFROMNet = "Anagrafiche_Statistiche_Fatturato_Vw";

...
public partial class _Default : System.Web.UI.Page 
{
    ...
    public DataTable dtProdottiConsegna;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (Smartdesk.Login.Verify){
          dtLogin = Smartdesk.Data.Read("Utenti_Vw","Utenti_Ky", Smartdesk.Session.CurrentUser.ToString());          if (dtLogin.Rows.Count>0){
            ...
            if (strAzione!="new"){
                    strAzione = "modifica";
	        	dtProdottiConsegna = Smartdesk.Data.Read("ProdottiConsegna", "ProdottiConsegna_Ky",Smartdesk.Current.QueryString("ProdottiConsegna_Ky"));
            }
          }else{

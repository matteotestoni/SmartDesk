...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (strAnnunciCategorie_Ky!=null && strAnnunciCategorie_Ky.Length>0 && strAnnunciCategorie_Ky!="null"){
          ...
          strOutput+="<div class='large-10 medium-10 small-8 cell'>\n";
  		  ...
  		  switch (dtAttributi.Rows[j]["AttributiTipo_Ky"].ToString()){
  			...
  			case "4":
                ...
                strCheck+=" value=\"on\" />";
                strOutput+=strCheck;
  				//strOutput+="<input type=\"checkbox\" name=\"" + dtAttributi.Rows[j]["Attributi_Codice"].ToString() + "\" id=\"" + dtAttributi.Rows[j]["Attributi_Codice"].ToString() + "\" value=\"" + GetFieldValue(dtAnnunci, dtAttributi.Rows[j]["Attributi_Codice"].ToString()) + "\"" + strRequired + strClass + " />";
  				break;
  			case "5":
  		  ...
  		  if (dtAttributi.Rows[j]["Attributi_HelpText"].ToString().Length>0){
            strOutput+="<span class=\"help-text\">" + dtAttributi.Rows[j]["Attributi_HelpText"].ToString() + "</span>";      
          }
          strOutput+="</div>\n";
          strOutput+="</div>\n";
        }

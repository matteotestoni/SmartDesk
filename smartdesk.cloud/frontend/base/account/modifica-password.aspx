<%@ Page ResponseEncoding="utf-8" Language="C#" AutoEventWireup="true" CodeFile="modifica-password.aspx.cs" Inherits="_Default" Debug="true"%>
<!DOCTYPE html>
              ...
              <input type="hidden" name="Anagrafiche_EmailContatti" id="Anagrafiche_EmailContatti" value="<%=dtLogin.Rows[0]["Anagrafiche_EmailContatti"].ToString()%>">              
                  ...
                  <% } %>
						  ...
						  <div class="grid-x grid-padding-x">
						  	...
						  	<div class="large-10 medium-10 small-8 cell">
						      <%=GetFieldValue(dtLogin, "Anagrafiche_Indirizzo")%>
						  	</div>
						  </div>	
						  ...
						  <div class="grid-x grid-padding-x">
						  	...
						  	<div class="large-10 medium-10 small-8 cell">
						      <%=GetFieldValue(dtLogin, "Anagrafiche_Telefono")%>
						  	</div>
						  </div>
						  	
						  <div class="grid-x grid-padding-x">
						  	<div class="large-2 medium-2 small-4 cell">
						  		<label for="Anagrafiche_Password" class="large-text-right small-text-left middle">Nuova Password <i class="fa-duotone fa-key fa-fw"></i></label>
						  	</div>
						  	<div class="large-10 medium-10 small-8 cell">
						      <input type="password" name="Anagrafiche_Password" id="Anagrafiche_Password" title="Anagrafiche_Password" value="<%=GetFieldValue(dtLogin, "Anagrafiche_Password")%>" size="60">

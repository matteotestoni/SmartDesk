    ...
    DataTable dtCoreModulesOptionsValue;
      ...
      strAnagrafiche_Ky=(FormsAuthentication.Decrypt(Context.Request.Cookies["rswcrm-cliente"].Value)).UserData;
	    if (strAnagrafiche_Ky!=null){
            ...
            if (strAzione!="new"){
              strAzione = "modifica";
              strWHERENet="Anagrafiche_Ky=" + strAnagrafiche_Ky + " AND Commesse_Ky=" + Smartdesk.Current.QueryString("Commesse_Ky");
              strORDERNet = "Commesse_Ky";
              strFROMNet = "Commesse_Vw";
              dtCommesse = Smartdesk.Sql.getTablePage(strFROMNet, null, "Commesse_Ky", strWHERENet, strORDERNet, 1, 1, Smartdesk.Config.Sql.ConnectionReadOnly);
  			      //note

self.addEventListener('install', e => {
    ...
    caches.open('app_rswstudio_service_worker').then(cache => {
      return cache.addAll([
				...
				'https://cdn.smartdesk.cloud/lib/foundation-datepicker/css/foundation-datepicker.min.css',
		    'https://cdnjs.cloudflare.com/ajax/libs/select2/4.1.0-rc.0/css/select2.min.css',
				...
				'https://cdn.smartdesk.cloud/lib/foundation-datepicker/js/foundation-datepicker.min.js',
				'https://cdnjs.cloudflare.com/ajax/libs/select2/4.1.0-rc.0/js/select2.min.js',
				'https://cdn.smartdesk.cloud/lib/fontawesome6/css/all.min.css',

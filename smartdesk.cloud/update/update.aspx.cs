...
public partial class _Default : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        strH1="Aggiornamento";         
        //vecchio framework   
        strRisultato+="<h2>1 - Aggiornamento db</h2>";
        ...
        new Smartdesk.Sql().SQLScriptExecuteNonQuery(strSQL);
        strSQL="ALTER TABLE CoreModulesOptions alter column CoreModulesOptions_Default varchar(MAX);";
        new Smartdesk.Sql().SQLScriptExecuteNonQuery(strSQL);
        ...
        strRisultato += "<h2>2: Aggiornamento campi mancanti da XML a DB da cartella /admin/SqlDB/</h2>";
        strRisultato += Smartdesk.Functions.ManutenzioneAddFieldDBToXML();
        
        strRisultato += "<h2>3: Aggiornamento Viste da XML a DB da cartella /admin/SqlDB/</h2>";
        ...
        strDirectory=Server.MapPath("/uploads/foto-veicoli/");
        strRisultato += strDirectory + "<br>";
        if(!Directory.Exists(strDirectory))
        {
            Directory.CreateDirectory(strDirectory);
        ...
        strRisultato += "<h2>6: sistemazione dati</h2>";
        
        strRisultato += "1 - Utenti<br>";
        ...
        strRisultato += "2 - Amministrazione<br>";
        ...
        new Smartdesk.Sql().SQLScriptExecuteNonQuery(strSQL);
        strSQL="UPDATE VeicoliTipologie set VeicoliTipologie_Usato=0 WHERE VeicoliTipologie_Usato Is Null";  
        new Smartdesk.Sql().SQLScriptExecuteNonQuery(strSQL);
        strSQL="UPDATE VeicoliTipologie set VeicoliTipologie_Nuovo=0 WHERE VeicoliTipologie_Nuovo Is Null";  
        new Smartdesk.Sql().SQLScriptExecuteNonQuery(strSQL);
        strSQL="UPDATE VeicoliTipologie set VeicoliTipologie_Km0=0 WHERE VeicoliTipologie_Km0 Is Null";  
        new Smartdesk.Sql().SQLScriptExecuteNonQuery(strSQL);
        strSQL="UPDATE VeicoliTipologie set VeicoliTipologie_Sostitutiva=0 WHERE VeicoliTipologie_Sostitutiva Is Null";  
        new Smartdesk.Sql().SQLScriptExecuteNonQuery(strSQL);        
        
        strRisultato += "4 - Commerciale<br>";
        ...
        strRisultato += "<h2>7: Dati di default</h2>";

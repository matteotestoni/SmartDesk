...
public partial class _Default : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (Request.Cookies["rswcrm-az"] != null){
        ...
        strLogin="<li><a href=\"/login.aspx\" rel=\"nofollow\"><i class=\"fa-duotone fa-key fa-lg fa-fw\"></i><span class=\"hide-for-small-only\">Accedi</span></a><li></li><a href=\"/registrazione.aspx\"><i class=\"fa-duotone fa-user-plus fa-lg fa-fw\"></i><span class=\"hide-for-small-only\">Registrati</span></a><li>";
        boolLogin=false;
	    Response.Redirect("/account/login.html");
      }

...
{    
    ...
    protected void Page_Load(object sender, EventArgs e){
      ...
      inviaPassword();
      Response.Redirect("/password-inviata.aspx");
    }

    public bool inviaPassword()
    {
        string strEmailContatti = "";
        bool output = false;
        
        strEmailContatti = Request["email"];
        ...
        if (dtAnagrafiche.Rows.Count>0){
              ...
              string strSubject = "[ASTEBUSINESS] Recupero password";
              strCorpo ="<table width='100%' border='0' cellpadding='2' cellspacing='1' bgcolor='#000000'>";
              strCorpo +="<tr><td bgcolor=\"#FFFFFF\">";
      	      strCorpo += "<b>Nome:</b> " + dtAnagrafiche.Rows[0]["Anagrafiche_Nome"].ToString() + "<br />";
      	      strCorpo += "<b>Cognome:</b> " + dtAnagrafiche.Rows[0]["Anagrafiche_Cognome"].ToString() + "<br />";
              strCorpo += "<b>Telefono:</b> " + dtAnagrafiche.Rows[0]["Anagrafiche_Telefono"].ToString() + "<br />";
              strCorpo += "<b>Email:</b> " + dtAnagrafiche.Rows[0]["Anagrafiche_EmailContatti"].ToString() + "<br />";
              strCorpo += "<b>Password:</b> " + dtAnagrafiche.Rows[0]["Anagrafiche_Password"].ToString() + "<br />";

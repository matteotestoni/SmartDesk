			...
			<div class="ad-box">
				<div class="grid-x">
					<div class="ad-box-media xlarge-12 large-12 cell">
						<div class="lazyload" data-bg="<%=dtCMSContenuti.Rows[i]["CMSContenuti_Foto"].ToString()%>" style="background-size:cover;width:100%;height:100%;max-height:260px;min-height:260px;background-repeat:no-repeat;background-position:center center;">
